    ...
    return (
        <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-4">
                ...
                <p className="text-gray-600 mt-1">Set up a new subscription package with plans and features</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    <div className="flex items-center justify-between mb-6">
                        <h2 className="text-xl font-semibold text-gray-900">Plans <span className="text-error-500">*</span></h2>
                        <button
                            type="button"
                            onClick={addPlan}
                ...
                <div className="flex gap-4 justify-end">
                    ...
                    <button
                        ...
                        className="px-6 py-2 bg-blue-800 text-white rounded-lg hover:bg-blue-900 transition-colors font-medium disabled:opacity-50"
                    >
